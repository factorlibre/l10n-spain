...
class L10nEsAeatMod111Report(models.Model):
    ...
    def calculate(self):
        ...
        # El usuario introduce a mano el Nº de perceptores de los
        # rendimientos, tanto de los dinerarios como en especie.
        ...
        self.casilla_05 = sum([x.tax_amount for x in move_lines05])
        self.casilla_06 = sum([x.tax_amount for x in move_lines06])
